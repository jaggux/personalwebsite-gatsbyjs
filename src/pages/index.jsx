  ...
  <React.Fragment>
    ...
    <Parallax pages={4}>
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          <BigTitle>
            Hello, <br /> I'm Anmol Bajaj.
          </BigTitle>
          <Subtitle>I’m a computing science student aspiring to work on impactful products that solve hard probelms.</Subtitle>
        </Hero>
      </Content>
      ...
      <Content speed={0.4} offset={1}>
        <Inner>
          ...
          <ProjectsWrapper>
            <ProjectCard
              title="Easy Glucose"
              link="https://github.com/anmolbajajnet/EasyGlucose"
              bg="linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"
            >
              This open-source iOS app aims to help diabetic patients log their glucose.
            </ProjectCard>
            <ProjectCard
              title="BrightWhite Smile"
              link="https://brightwhitesmilepro.com"
              bg="linear-gradient(to right, #662D8C 0%, #ED1E79 100%)"
            >
              I created an ecommerce business that over 45,000 customers based on word of mouth and online advertising.
            </ProjectCard>
            <ProjectCard
            ...
            >
              Familiarized myself with GatsbyJS, a static Progressive Web App generator based on React. This is an open-source theme, however, I plan to create the design from scratch.
            </ProjectCard>
            <ProjectCard
              title="Gravity BJJ"
            ...
            >
              I worked with a martial arts school to create an app to track member attendance using QR codes.
            </ProjectCard>
          </ProjectsWrapper>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={2}>
        <Inner>
          <Title>About</Title>
          <AboutHero>
            <Avatar src={avatar} alt="Anmol Bajaj" />
            <AboutSub>
            I fell in love with computers at the age of 7 when I first used one at an internet cafe. I came home and begged my mother to get me one. She took out a bank loan and brought home a computer. I was hooked.
            </AboutSub>
          </AboutHero>
          <AboutDesc>
          I'm a 3rd year computing science student at Simon Fraser University. With a passion for everything from full-stack web development to mobile development, I am truly a generalist. I'm currently seeking co-op or job opportunities to apply my existing skills and learn new technologies.
          </AboutDesc>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          ...
          <ContactText>
            Say <a href="mailto:hello@anmolbajaj.net">Hi</a> or find me on other platforms:{' '}
            <a href="https://twitter.com/anmolbajajnet">Twitter</a> &{' '}
            <a href="https://www.linkedin.com/in/anmolbajajnet/">LinkedIn</a>
          </ContactText>
        </Inner>
        <Footer>
          &copy; 2018 Built with GatsbyJS.{' '}
          <a href="https://github.com/LeKoArts/gatsby-starter-portfolio-cara">Portfolio Cara.</a>
        </Footer>
      </Content>
